...
for countryID in country_list:
    country_df = df_covid[['date','country','confirmed_pct','deaths_pct','recovered_pct']]
...
#df_covid = df_covid[df_covid['country']=='Denmark'] 


#df_covid.to_csv('df_covid.csv', index=False)

#df_confirmed.to_csv('df_confirmed.csv', index=False)